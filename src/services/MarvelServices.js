...
class MarvelSerices {
    ...
    _apiKey = "apikey=0b6afc473a8c391220422cd19a225814";
    _baseOffset = 333;
    ...
    _transformCharacter = (char) => {
        return {
            id: char.id,
            name: char.name,
            description: char.description ? char.description + "..." : "К большому сожалению описание отсутствует",
